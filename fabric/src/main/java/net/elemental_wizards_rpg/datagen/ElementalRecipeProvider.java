    ...
    public void generate() {
        ...
        createShapedRecipe("staff_aqua",
                ...
                "C", net.minecraft.registry.tag.TagKey.of(
                        ...
                        new Identifier("more_rpg_classes", "coral_plants")
                )
        );
        ...
        createConditionalShapedRecipe("staff_crystal_aqua",
                ...
                "betterend",
                "A", Items.PRISMARINE_CRYSTALS,
                "B", new Identifier("betterend", "crystal_shards"),
                "C", new Identifier("betterend", "aeternium_ingot")
        );
        ...
        createConditionalShapedRecipe("staff_ruby_terra",
                ...
                new String[]{" BA", " CB", "C  "},
                "betternether",
                "A", new Identifier("betternether", "nether_ruby"),
                "B", Items.OBSIDIAN,
