...
public class EarthquakeEntity extends Entity implements SpellEntity.Spawned {
    ...
    private static final TrackedData<Integer> OWNER_ID_TRACKER = DataTracker.registerData(EarthquakeEntity.class, TrackedDataHandlerRegistry.INTEGER);
    ...
    private void damageEntities() {
        ...
        for (Entity entity : entities) {
            ...
            if (!isProtected(owner, entity)) {
                RegistryEntry<Spell> spellImpact = SpellRegistry.from(owner.getWorld()).getEntry(Identifier.of(MOD_ID, "terra_earthquake_impact")).get();
